...
'''
Code from https://github.com/alpacahq/alpaca-trade-api-python/blob/master/examples/martingale.py
Used as placeholder while I write my own.
It has been edited to work with the program.
'''
